...
<body>
				...
				<nav class="navbar navbar-green">
					...
					<div class="navbar-header">
						<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
							...
							<a class="navbar-brand" onclick="openNav()"><span  class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp;Home</a>
					</div>
  ...
  <thead>
    <tr>
      <th>Total Number of Present</th>
	  <th>Total Number of Late</th>
	  <th>Total Number of Absent</th>
	   <th>Total Number of Excuse</th>
 ...
 <center> <a href="take.php" button type="button" class="btn btn-warning">Back</a></button></center>
</div>
