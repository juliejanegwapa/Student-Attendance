...
<body>
    ...
    <div id="wrapper">
       ...
       <!-- Sidebar -->
			...
			<ul class="sidebar-nav">
				...
				<li>
					<a href="subjectview.php" title="Subject"><span class="glyphicon glyphicon-book"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Subject</a>
				</li>
				<li>
				...
				<nav class="navbar navbar-green">
					...
					<div class="navbar-header">
						<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
							...
							<a class="navbar-brand" onclick="openNav()"><span  class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp;Student Class View</a>
					</div>
  ...
  <thead>
    <tr>
      <th>Student_ID</th>
	  <th>Class_ID</th>
      <th><a href="studentclass.php" button type="button" class="btn btn-primary">Add Student Class</a></button></th>
...
<a class="dropdown-item" href="studclasspros.php?delete=<?php echo $row["number"]; ?>" onclick="return confirm('Are you sure?');">Delete</a>
